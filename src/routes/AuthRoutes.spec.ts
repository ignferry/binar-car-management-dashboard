...
describe('Test Auth Registration Route: POST /api/v1/auth/register', () => {
  const mainApp = new App([new AuthRoutes()]);
...
describe('Test Auth Login Route: POST /api/v1/auth/login', () => {
  const mainApp = new App([new AuthRoutes()]);
  const app = mainApp.app;
